...
--Signals for bird
  ...
  SIGNAL collision, death				: std_logic:= '0';
  SIGNAL pipe_x_pos, bird_x_pos : std_logic_vector(10 downto 0);
  SIGNAL pipe_y_pos, bird_y_pos : std_logic_vector(9 DOWNTO 0);
...
pipe_start  <= '1';
    ...
    player_dead <= collision or death;
...
HEART3 : entity work.heart
    ...
    -- ADDED COMPONENTS
    --For bird movement
    -- Instantiate bird component
    bird_COMPONENT: entity work.bird
    PORT MAP (enable=> bird_enable, 
            click => left_click, 
            clk => clock_25Mhz, 
            vert_sync => vert_sync,
            pixel_row => pixel_row, 
...
red_in   <= pipe_r when pipe_on = '1' else bird_r when bird_on = '1' else bean_r when bean_on_temp = '1' else "0000";
green_in <= pipe_g when pipe_on = '1' else bird_g when bird_on = '1' else bean_g when bean_on_temp = '1' else "0000";
blue_in  <= pipe_b when pipe_on = '1' else bird_b when bird_on = '1' else bean_b when bean_on_temp = '1' else "0000";
